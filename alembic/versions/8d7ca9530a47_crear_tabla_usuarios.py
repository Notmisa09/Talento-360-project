...
Revision ID: 8d7ca9530a47
Revises: 
Create Date: 2026-08-12 00:19:43.338996
...
def upgrade() -> None:
    ...
    sa.Column('rol', sa.Enum('ADMIN_RRHH', 'SUPERVISOR', 'EMPLEADO', name='rolenum', native_enum=False, length=20), nullable=False),
